...
const UsersStaticWebpageGenerator = require("./users_static_webpage_generator");
...
const USERS = [
    ...
    new User(
      "Geraldine Rivia",
      "Redactora, editora y correctora con base en Madrid.\n\n" +
  ...
  const generator = new UsersStaticWebpageGenerator();
